...
def main() -> None:
    ...
    config = load_from_yaml(local_path / "config.yaml")
    update_sql = load_from_txt(local_path / "sql/update_public_cds.sql" )
    init_sql = load_from_txt(local_path / "sql/init_db.sql" )
