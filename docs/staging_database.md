...
| is_left_side_oneway | BOOLEAN            | Indicates that the curb segment is on the left side of a one way street |
...
| job_description | VARCHAR            | Extended description of a curb segments job. This should include information such as the version of the curb segmenter program and the source of the curb geography (e.g., "MassDOT streets layer current as of 12-22-2025"). |
